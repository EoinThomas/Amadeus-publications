...
- **Venue:** ICLR 2020
- **Year:** 2020
- **Link:** [OpenReview](https://openreview.net/forum?id=BJgWE1SFwS)
...
- Novel neural architecture for discrete choice modeling
- Integration of Markov chain theory with deep learning
- Efficient handling of variable-sized choice sets
- Strong empirical results on travel choice prediction
- Theoretical analysis of model properties and convergence
